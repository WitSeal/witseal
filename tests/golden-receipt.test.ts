 ...
 *
 * Reproduces the cycle-69 Rust authoritative artifact
 ...
 *
 *   2. The Rust S1 clear-defaults construction procedure (per cycle-68
...
// node:crypto). See the cycle-68 key fixture for cross-track equivalents
