 ...
 * ─── What this proves ────────────────────────────────────────────────────────
 *
 * PR #25 (B9 three-way demo) proved SERIALIZATION parity: TS, Python, and Rust
 * each canonicalize an already-constructed receipt to byte-identical output.
 *
 * This file closes the INDEPENDENT GENERATION gap (flagged by the Python TL):
...
// Expected wire-form values from inputs.json (cycle-69 captured):
